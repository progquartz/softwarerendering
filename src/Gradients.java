public class Gradients
{
    ...
    public Gradients(Vertex minYVert, Vertex midYVert, Vertex maxYVert){
        ...
        m_colorXStep =
                (((m_color[1].Sub(m_color[2])).Mul((minYVert.GetY() - maxYVert.GetY())))
                .Sub(((m_color[0].Sub(m_color[2])).Mul((midYVert.GetY() - maxYVert.GetY()))))).Mul(oneOverdX);

        m_colorYStep =
                (((m_color[1].Sub(m_color[2])).Mul((minYVert.GetX() - maxYVert.GetX())))
                .Sub(((m_color[0].Sub(m_color[2])).Mul((midYVert.GetX() - maxYVert.GetX()))))).Mul(oneOverdY);
    }
}
